                      ...
                      {['Oxford', 'Derby', 'Loafer'].map((style) => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <Sparkles className="h-4 w-4 text-neutral-400 opacity-0 group-hover:opacity-100 transition-opacity" style={{ color: '#5A6F8D' }} />
                          </div>
                        </button>
                      ))}
                    </div>
                    ...
                    >
                      ...
                      <div className="p-3 lg:p-6">
                        <div className="mb-1 lg:mb-2">
                          <Badge variant="outline" className="text-xs uppercase tracking-wider border" style={{ fontFamily: 'Argent CF', borderColor: '#5A6F8D', color: '#5A6F8D' }}>
                        ...
                        <Button 
                          className="w-full bg-neutral-900 text-white hover:bg-neutral-800 hover:opacity-90 uppercase tracking-wider text-xs lg:text-sm py-2 border-0 lg:block hidden"
