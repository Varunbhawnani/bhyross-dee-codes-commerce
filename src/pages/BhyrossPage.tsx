...
const BhyrossPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12 md:pb-16 bg-gradient-to-br from-bhyross-50 to-neutral-50">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Button size="lg" className="bg-bhyross-500 hover:bg-bhyross-600 w-full sm:w-auto">
                  Shop Collection
                </Button>
            ...
            <div className="relative mt-8 lg:mt-0">
              <img
                ...
                className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] object-cover rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl"
                loading="lazy"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="p-4 sm:p-6 text-center hover-lift">
                <feature.icon className="h-10 w-10 sm:h-12 sm:w-12 text-bhyross-500 mx-auto mb-3 sm:mb-4" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-4 sm:p-6">
                ...
                <p className="text-sm sm:text-base text-neutral-600 mb-3 sm:mb-4 italic">
                  "{testimonial.comment}"
                </p>
                <div className="border-t pt-3 sm:pt-4">
                  <div className="font-semibold text-neutral-900 text-sm sm:text-base">{testimonial.name}</div>
