...
const ImcolusPage: React.FC = () => {
  ...
  const { data: categoriesData } = useCategories('imcolus');
  ...
  const handleCardClick = (product: any) => {
    window.location.href = `/imcolus/${product.category}/${product.id}`;
  };
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="pt-16 flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="mt-4 text-neutral-600" style={{ fontFamily: 'Signika' }}>Loading Imcolus Collection...</p>
          </div>
        </div>
      ...
      <main className="pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 lg:py-16">
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 lg:mb-6" style={{ fontFamily: 'Cornerstone', color: '#A89F91' }}>
              Imcolus
            </h1>
            <div className="w-16 lg:w-24 h-0.5 mx-auto mb-4 lg:mb-6" style={{ backgroundColor: '#A89F91', opacity: 0.3 }}></div>
                  ...
                  <div className="bg-white border border-neutral-200 rounded-lg p-6 shadow-sm">
                    ...
                    <div className="mt-6 bg-gradient-to-r from-neutral-50 to-neutral-100 p-4 rounded-lg border border-neutral-200">
                      <p className="text-sm text-neutral-600 text-center">
                        <span className="font-bold" style={{ color: '#A89F91' }}>{filteredProducts.length}</span> 
...
<div className="lg:hidden relative">
  ...
  <p className="font-bold text-base md:text-lg mb-3" style={{ color: '#A89F91' }}>
